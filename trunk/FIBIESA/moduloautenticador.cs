...
namespace FIBIESA
{
    public class moduloautenticador : IHttpModule
    {
        ...
        private void PreRequestHandlerExecute(Object source, EventArgs e)
        {
            ...
            if (!origem.Contains("aspx") || origem.Contains("Rel") || origem.Contains("default.aspx") || origem.Contains("Pesquisar.aspx") || origem.Contains("PesquisarItens.aspx") || origem.Contains("recuperacaoLogin.aspx"))
            {
                return;
            }
