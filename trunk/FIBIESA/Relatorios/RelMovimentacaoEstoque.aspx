<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RelMovimentacaoEstoque.aspx.cs" Inherits="FIBIESA.Relatorios.RelMovimentacaoEstoque" %>
<%@ Register assembly="Microsoft.ReportViewer.WebForms, Version=10.0.0.0, Culture=neutral, PublicKeyToken=b03f5f7f11d50a3a" namespace="Microsoft.Reporting.WebForms" tagprefix="rsweb" %>
<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FIBIESE - Relatório de Movimentação do Estoque</title>
    ...
    <form id="form1" runat="server">
        ...
        <div id="divRelatorio" runat="server">
            <rsweb:ReportViewer ID="rptMovestoque" runat="server" Height="570px" 
                ...
                <LocalReport reportpath="Relatorios\rptMovimentacaoEstoque.rdlc">
                </LocalReport>
            </rsweb:ReportViewer>
        </div>
