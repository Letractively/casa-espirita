<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true"
    CodeBehind="cadContasApagar.aspx.cs" Inherits="FIBIESA.cadContasApagar" %>
                        ...
                        <table>
                            <tr>
                                ...
                                <td style="width: 400px" colspan="3">
                                    <asp:DropDownList ID="ddlTipoDoc" runat="server" CssClass="dropdownlist" ToolTip="Informe o tipo de documento">
                                    </asp:DropDownList>
                            ...
                            <tr>
                                ...
                                <td style="width: 400px" colspan="3">
                                    ...
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="txtFornecedor"
                                        CssClass="validacao" ErrorMessage="*Informe o fornecedor" ValidationGroup="salvar">*</asp:RequiredFieldValidator>
                                </td>
                            </tr>
                            <tr>
                                <td style="width: 140px">
                            ...
                            <tr>
                                ...
                                <td style="width: 400px">
                                    <asp:TextBox ID="txtDtPagamento" runat="server" CssClass="inputbox" Width="100px"
                                        ToolTip="Informe a data de pagamento" MaxLength="12"></asp:TextBox>
                            ...
                            <tr>
                                ...
                                <td style="width: 400px">
                                    ...
                                    <asp:Button ID="btnSalvar" runat="server" Text="Salvar" CssClass="btn" OnClick="btnSalvar_Click"
                                        ValidationGroup="salvar" ToolTip="Salva o título contas a pagar" />
                                </td>
                            </tr>
                        </table>
                    </div>
