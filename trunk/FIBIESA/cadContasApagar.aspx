<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="cadContasApagar.aspx.cs" Inherits="FIBIESA.cadContasApagar" %>
                    ...
                    <tr>
                        ...
                        <td style="width: 400px">
                            <asp:TextBox ID="txtTitulo" runat="server" CssClass="inputboxRight" 
                                Width="100px" ToolTip="Informe o número do título" MaxLength="10"></asp:TextBox>
                        ...
                        <td style="width: 400px">
                            <asp:TextBox ID="txtParcela" runat="server" CssClass="inputboxRight" 
                                Width="50px" ToolTip="Informe a parcela" MaxLength="3"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 400px" colspan="3">
                            <asp:TextBox ID="txtValor" runat="server" CssClass="inputboxValor" 
                                Width="100px" ToolTip="Informe o valor do título" MaxLength="12"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 400px">
                            <asp:TextBox ID="txtDataEmissao" runat="server" CssClass="inputbox" 
                                Width="100px" ToolTip="Informe a data de emissão" MaxLength="10"></asp:TextBox>
                        ...
                        <td style="width: 400px">
                            <asp:TextBox ID="txtDataVencimento" runat="server" CssClass="inputbox" 
                                Width="100px" ToolTip="Informe a data de vencimento" MaxLength="10"></asp:TextBox>
                    ...
                    <tr>
                        ...
                        <td style="width: 400px">
                            <asp:TextBox ID="txtDtPagamento" runat="server" CssClass="inputbox" 
                                Width="100px" ToolTip="Informe a data de pagamento" MaxLength="12"></asp:TextBox>
                        ...
                        <td style="width: 400px">
                            <asp:TextBox ID="txtVlrPago" runat="server" CssClass="inputboxValor" 
                                Width="100px" ToolTip="Informe o valor pago" MaxLength="12"></asp:TextBox>
                        </td>
                    </tr> 
                     <tr>
                        <td style="width: 140px">
