<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true"
    CodeBehind="viewObra.aspx.cs" Inherits="Admin.viewObra" %>
            ...
            <div class="contentbox">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:GridView ID="dtgObras" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowPaging="True"
                                    DataKeyNames="ID" OnRowDeleting="dtgObras_RowDeleting" OnSelectedIndexChanged="dtgObras_SelectedIndexChanged"
                                    AllowSorting="True" GridLines="None" OnPageIndexChanging="dtgObras_PageIndexChanging"
                                    OnRowDataBound="dtgObras_RowDataBound" OnSorting="dtgObras_Sorting">
                                    <Columns>
