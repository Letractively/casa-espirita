...
namespace FIBIESA
{
    public partial class viewRelContasReceber : System.Web.UI.Page
    {
        ...
        public void CarregarPesquisaPortador(string conteudo)
        {
            DataTable dt = new DataTable();
            DataColumn coluna1 = new DataColumn("ID", Type.GetType("System.Int32"));
            DataColumn coluna2 = new DataColumn("CODIGO", Type.GetType("System.String"));
            ...
            List<Portadores> lPortadores = porBL.PesquisarBuscaBL(conteudo);
            foreach (Portadores pes in lPortadores)
            {
                DataRow linha = dt.NewRow();
            ...
            grdPesquisaPortador.DataSource = dt;
            grdPesquisaPortador.DataBind();
        }
        #endregion
        ...
        public DataTable pesquisaTipoDocumento()
        {
            ...
            List<TiposDocumentos> lTiposDocumentos;
                ...
                lTiposDocumentos = tipoDoBL.PesquisarBL("CR");
        ...
        protected void btnSelectPortador_Click(object sender, EventArgs e)
        {

            ImageButton btndetails = sender as ImageButton;
            GridViewRow gvrow = (GridViewRow)btndetails.NamingContainer;

            if (Session["IntPortador"] != null || Session["IntPortador"] != null)
                txtPortador.Text = Session["IntPortador"].ToString() + ",";

            txtPortador.Text = txtPortador.Text + gvrow.Cells[2].Text;
            Session["IntPortador"] = txtPortador.Text;
            ModalPopupExtenderPesquisaPortador.Hide();
            ModalPopupExtenderPesquisaPortador.Enabled = false;
        }
        ...
        protected void btnCancelPortador_Click(object sender, EventArgs e)
        {
            ModalPopupExtenderPesquisaPortador.Enabled = false;
        }
        ...
        protected void btnRelatorio_Click(object sender, EventArgs e)
        {
            ...
            Session["ldsRel"] = titulosBL.PesquisarBuscaDataSetBL(txtTitulo.Text, txtAssociado.Text, txtPortador.Text, "CR", ddlTipoDocumento.SelectedValue,blAtrasados,txtDataEmissaoIni.Text,txtDataEmissaoFim.Text,txtDataVencimentoIni.Text,txtDataVencimentoFim.Text, txtDataPagamentoIni.Text, txtDataPagamentoFim.Text).Tables[0];
        ...
        protected void grdPesquisaPortador_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
                utils.CarregarEfeitoGrid("#c8defc", "#ffffff", e);
        }
