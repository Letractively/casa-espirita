<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true" CodeBehind="viewBancosInstrucoes.aspx.cs" Inherits="FIBIESA.viewBancosInstrucoes" %>
            ...
            <div class="contentbox">
                ...
                <div class="contentbox">
                    <table width="100%">
                        <tr>
                            <td>
                                <asp:GridView ID="dtgBancos" runat="server" AutoGenerateColumns="False" BackColor="White"
                                    BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" CellPadding="3" AllowPaging="True"
                                    DataKeyNames="ID" OnRowDeleting="dtgBancos_RowDeleting" OnSelectedIndexChanged="dtgBancos_SelectedIndexChanged"
                                    AllowSorting="True" GridLines="None" OnPageIndexChanging="dtgBancos_PageIndexChanging"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="NRDIAS" HeaderText="Obriga Dias" SortExpression="NRDIAS"/>
                                    </Columns>
