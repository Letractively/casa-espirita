...
namespace FG
{
    public class Utils
    {
        ...
        public string Encrypt(string plainText)
        {
            ...
            int keySize = 128;
            string passPhrase = "sct0102";
            string saltValue = "sct0102";
        ...
        public byte[] gravaAnexo(Stream fileup)
        {
            // Stream imgstream = fileup.PostedFile.InputStream;
            System.IO.BinaryReader br = new System.IO.BinaryReader(fileup);
            Byte[] abyt = br.ReadBytes((int)fileup.Length);
            br.Close();
            return abyt;
        }      
