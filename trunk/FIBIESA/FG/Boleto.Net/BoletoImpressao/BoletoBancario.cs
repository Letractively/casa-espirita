...
namespace BoletoNet
{
    ...
    public class BoletoBancario : System.Web.UI.Control
    {
        ...
        private string MontaHtml(string urlImagemLogo, string urlImagemBarra, string imagemCodigoBarras)
        {
            ...
            string labelNossoNumero = "Carteira / Nosso Número";
            if (!MostrarCodigoCarteira)
                labelNossoNumero = "Nosso Número";

            string nossoNumero = Boleto.NossoNumero + "-" + Boleto.NossoNumeroDV;
            ...
            return html
                ...
                .Replace("@LABELNOSSONUMERO", labelNossoNumero)
