...
{
    public partial class RelContasPagar : System.Web.UI.Page
    {
        ...
        private void geraRelatorio()
        {
            ...
            if (lDtPesquisa.Rows.Count > 0)
            {
                ...
                rptContasPagar.LocalReport.SetParameters(param);
                rptContasPagar.LocalReport.DataSources.Add(rptDatasourceInstituicao);
                rptContasPagar.LocalReport.DataSources.Add(rptDatasourceInstituicaoLogo);
                rptContasPagar.LocalReport.DataSources.Add(rptDatasourceContas);

                rptContasPagar.LocalReport.Refresh();
                //Session["ldsRel"] = null;
            }
            else
            {
