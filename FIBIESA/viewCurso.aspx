<%@ Page Title="" Language="C#" MasterPageFile="~/home.Master" AutoEventWireup="true"
    CodeBehind="viewCurso.aspx.cs" Inherits="Admin.viewCurso" %>
            ...
            <div class="contentbox">
                ...
                <div class="contentbox">
                    <table width="100%">
                       <tr>
                            <td>                       
                               <asp:GridView ID="dtgCursos" runat="server" AutoGenerateColumns="False" 
                                   BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                                   CellPadding="3" AllowPaging="True" DataKeyNames="ID" 
                                   onrowdeleting="dtgCursos_RowDeleting" 
                                   onselectedindexchanged="dtgCursos_SelectedIndexChanged" PageSize="7" 
                                    AllowSorting="True">
                                   <Columns>
