...
namespace FIBIESA
{
    public partial class viewContasReceber : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("cadContasReceber.aspx?operacao=new");
        }
        ...
        protected void dtgTitulos_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            Response.Redirect("cadContasReceber.aspx?id_tit=" + str_tit.ToString() + "&operacao=edit");
        }
