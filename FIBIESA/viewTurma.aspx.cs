...
namespace Admin
{
    public partial class viewTurma : System.Web.UI.Page
    {
        ...
        private void Pesquisar()
        {
            ...
            DataColumn coluna4 = new DataColumn("CURSOID", Type.GetType("System.Int32"));
            DataColumn coluna5 = new DataColumn("DATAINICIAL", Type.GetType("System.DateTime"));
            DataColumn coluna6 = new DataColumn("DATAFINAL", Type.GetType("System.DateTime"));
        ...
        protected void dtgTurmas_SelectedIndexChanged(object sender, EventArgs e)
        {
            int str_tur = 0;
