                                        ...
                                        <table>
                                            <tr>
                                                ...
                                                <td style="width: 400px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator6" runat="server" ControlToValidate="txtCep"
                                                        ErrorMessage="Informe o CEP - Aba Endereço" ForeColor="#CC0000" ValidationGroup="salvar">*</asp:RequiredFieldValidator>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 500px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="ddlCidades"
                                                        ErrorMessage="Informe a Cidade - Aba Endereço" ForeColor="#CC0000" ValidationGroup="salvar">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 140px">
                                                ...
                                                <td style="width: 500px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="ddlBairro"
                                                        ErrorMessage="Informe o Bairro - Aba Endereço" ForeColor="#CC0000" ValidationGroup="salvar">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 140px">
                                                ...
                                                <td style="width: 500px">
                                                    <asp:TextBox ID="txtEndereco" runat="server" CssClass="inputbox" MaxLength="70" Width="335px"
                                                        ToolTip="Informe o endereço"></asp:TextBox><asp:RequiredFieldValidator ID="RequiredFieldValidator3"
                                                            runat="server" ControlToValidate="txtEndereco" ErrorMessage="Informe o Endereço - Aba Endereço"
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 500px">
                                                    ...
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtNumero"
                                                        ErrorMessage="Informe o Número - Aba Endereço" ForeColor="#CC0000" ValidationGroup="salvar">*</asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 140px">
                                            ...
                                            <tr>
                                                <td colspan="4">
                                                    <asp:GridView ID="dtgTelefones" runat="server" AutoGenerateColumns="False" BackColor="White"
                                                        ...
                                                        OnRowDeleting="dtgTelefones_RowDeleting" GridLines="None" OnRowDataBound="dtgTelefones_RowDataBound">
                                                        <Columns>
                                    ...
                                    <ContentTemplate>
                                        <table>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 400px">
                                                    <asp:TextBox ID="txtCepProf" runat="server" CssClass="inputbox" MaxLength="9" Width="110px"
                                                        ToolTip="Informe o CEP profissional"></asp:TextBox>
                                                    <asp:RegularExpressionValidator ID="RegularExpressionValidator2" runat="server" ErrorMessage="*"
                                                        ToolTip="Não Válida" SetFocusOnError="True" ControlToValidate="txtCepProf" ValidationExpression="^\d{5}-?\d{3}$"
                                                        Display="Dynamic" ValidationGroup="salvar" ForeColor="Red" CssClass="labelValignMiddle"></asp:RegularExpressionValidator>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 500px">
                                                    <asp:DropDownList ID="ddlUfProf" runat="server" CssClass="dropdownlist" AutoPostBack="True"
                                                        ToolTip="Selecione a UF profissional" OnSelectedIndexChanged="ddlUfProf_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 400px">
                                                    <asp:DropDownList ID="ddlCidadeProf" runat="server" CssClass="dropdownlist" AutoPostBack="True"
                                                        ToolTip="Selecione a cidade profissional" OnSelectedIndexChanged="ddlCidadeProf_SelectedIndexChanged">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                                ...
                                                <td style="width: 400px">
                                                    <asp:DropDownList ID="ddlBairroProf" runat="server" CssClass="dropdownlist" AutoPostBack="True"
                                                        ToolTip="Selecione o bairro profissional">
                                                    </asp:DropDownList>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 400px">
                                                    <asp:TextBox ID="txtNumeroProf" runat="server" CssClass="inputbox" MaxLength="20"
                                                        Width="110px" ToolTip="Informe o número"></asp:TextBox>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="width: 140px">
                                        ...
                                        <table>
                                            <tr>
                                                <td style="width: 540px; height: 700px;">
                                                    ...
                                                    <center>
                                                        <asp:LinkButton ID="lbFinaliza" runat="server" Font-Bold="True" 
                                                            Font-Size="Large" Font-Underline="True" ForeColor="Blue" 
                                                            onclick="lbFinaliza_Click">Finalizar Operação !</asp:LinkButton>
                                                    </center>
