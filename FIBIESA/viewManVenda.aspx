           ...
           <div class="contentbox">
                ...
                <div class="contentbox">
                    <table width="100%">
                       <tr>
                            <td>                       
                               <asp:GridView ID="dtgVendas" runat="server" AutoGenerateColumns="False" 
                                   BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                                   CellPadding="3" AllowPaging="True" DataKeyNames="ID" 
                                   onselectedindexchanged="dtgVendas_SelectedIndexChanged" 
                                    AllowSorting="True" GridLines="None" 
                                    onpageindexchanging="dtgVendas_PageIndexChanging" 
                                    onrowdatabound="dtgVendas_RowDataBound" onsorting="dtgVendas_Sorting">
                                   <Columns>
                                       ...
                                       <asp:BoundField DataField="NOMEPESSOA" HeaderText="Cliente" 
                                           SortExpression="NOMEPESSOA" />
                                       <asp:BoundField DataField="NOMEUSUARIO" HeaderText="Vendedor" 
