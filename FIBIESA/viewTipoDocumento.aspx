...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">   
    <div id="content">
        <div class="container">
            <div class="conthead">
                <h2>Cadastro de Tipos de Documentos</h2>
            </div>
            <div class="contentbox">
                ...
                <div class="contentbox">
                    <table width="100%">
                       <tr>
                            <td>                       
                               <asp:GridView ID="dtgTipoDocumento" runat="server" AutoGenerateColumns="False" 
                                   BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" 
                                   CellPadding="3" AllowPaging="True" DataKeyNames="ID" 
                                   onrowdeleting="dtgTipoDocumento_RowDeleting" 
                                   onselectedindexchanged="dtgTipoDocumento_SelectedIndexChanged" 
                                    AllowSorting="True" GridLines="None" 
                                    onpageindexchanging="dtgTipoDocumento_PageIndexChanging" 
                                    onrowdatabound="dtgTipoDocumento_RowDataBound" 
                                    onsorting="dtgTipoDocumento_Sorting" ShowHeaderWhenEmpty="True">
                                   <Columns>
